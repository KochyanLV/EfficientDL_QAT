...
def build_ckpt_name(model, extra: dict = None, with_values: bool = True) -> str:
    """
...
def save_ckpt_from_init(model, folder: str = "espcn/checkpoints", 
                        extra: dict = None, with_values: bool = True) -> str:
